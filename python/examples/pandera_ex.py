...
if __name__ == "__main__":
    ...
    # Make sure to make "https://gender-pay-gap.service.gov.uk/viewing/download-data/2021"
    # available as ./data/2021
    uk_df = spark.read.csv(
        "data/fetched/2021", header=True,
        inferSchema=True
    )
