...
object RDDJoinExamples {
 ...
 for each address. Like this:
  ...
  def outerJoinScoresWithAddress(
      scoreRDD: RDD[(Long, Double)],
      addressRDD: RDD[(Long, String)]
  ): RDD[(Long, (Double, Option[String]))] = {
 ...
 'ToDO: Insert the code to show this here' */
  ...
  def joinScoresWithAddress3(
    ...
    val bestScoreData = scoreRDD.reduceByKey(
